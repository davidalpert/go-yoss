...
// This file was generated by robots at 2023-03-12 12:10:26.971943 -0500 CDT m=+0.050391126
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "yoss",
		BuildDate:            "2023-03-12 12:10:26.971943 -0500 CDT m=+0.050391126",
		CoreVersion:          "0.1.0",
		GitBranch:            "main",
		GitCommit:            "ecb78a4",
		GitCommitSummary:     "build: release build needs ruby if we are running features",
		GitDirty:             false,
		GitDirtyHasModified:  false,
		GitDirtyHasStaged:    false,
		GitDirtyHasUntracked: false,
		Version:              "0.1.0+ecb78a4",
	}
